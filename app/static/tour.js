/* Контекстное обучение кабинета запускается только по явному намерению из
   чек-листа или профиля. Каждый раздел запоминается отдельно для аккаунта. */
(function () {
  "use strict";
  ...
  var DEFINITIONS = {
    dashboard: [
      ...
      { sel: '[data-tour="dashboard-share"]', title: "Поделись подборкой",
        text: "Проверь страницу гостя, затем скопируй ссылку и отправь её участникам." }
    ],
    "date-editor": [
      ...
      { sel: '[data-tour="date-modifiers"]', title: "Условия участия",
    ...
    "category-editor": [
      { sel: '[data-tour="category-dates"]', title: "Сначала добавь события",
      ...
      { sel: '[data-tour="category-actions"]', title: "Поделись ссылкой",
        text: "Проверь гостевую страницу, скопируй ссылку и отправь её участникам." },
      ...
      { sel: '[data-tour="category-skin"]', title: "Оформление страницы", pad: 12,
        text: "Выбери стандартный или романтический дизайн. Тему увидят все, кто откроет ссылку." },
      { sel: '[data-tour="category-preview"]', title: "Превью ссылки",
        text: "Дополнительное оформление можно настроить после основного сценария." }
    ]
  };
  ...
  function boot() {
    ...
    // Никакого автоматического модального тура: он запускается только кнопкой
    // пользователя или явным #tour=... после перехода из профиля/checklist.
  }
