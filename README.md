...
Для каждой категории можно выбрать оформление публичной ссылки: **«Дружеский»**
с индиго-бирюзовой палитрой и нейтральными иконками или сохранённый авторский
**«Романтический»** дизайн. Новые категории создаются дружескими, а существующие
после обновления сохраняют прежний вид. Оформление личного кабинета выбирается
отдельно в профиле и не влияет на гостевые ссылки; светлая/тёмная тема остаётся
настройкой конкретного браузера.
...
Тот же бот шлёт уведомления о голосах/вопросах и алёрты о сбоях. Нужен `TG_CHAT_ID`:
